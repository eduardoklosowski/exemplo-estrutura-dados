...
public class Ex03ListaLincada {
    @Test
    public void testaListaLincada() {
        // Cria uma lista de inteiros utilizando a implementação ListaLincada
        Lista<Integer> lista = new ListaLincada<Integer>();
